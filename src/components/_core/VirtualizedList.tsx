...
import type { VirtuosoProps, VirtuosoHandle, ListItem as OriginalListItem } from "react-virtuoso";
...
export interface VirtualizedListProps extends Omit<VirtuosoProps<ItemData, Context>, "style"> {
    style?: CSSProperties;
